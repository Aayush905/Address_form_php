...
// $order_bstate = 'asc';
 if($caller=="ebsA"){
    $sql = "SELECT * FROM info ORDER BY Bstate LIMIT {$offset},{$limit_per_page}";
    // $order_bstate='asc';
 }else if($caller=="ebsB"){
    $sql = "SELECT * FROM info ORDER BY Bstate DESC LIMIT {$offset},{$limit_per_page}";
    // $order_bstate='desc';
 }
 // <th id="ebs" order="'.$order_bstate.'">Bstate</th>
  ...
  <tbody>'; 
    ...
    if($caller=="ebsA"){
        $temp="SELECT * FROM info ORDER BY Bstate";
    }else if($caller=="ebsB"){
        $temp="SELECT * FROM info ORDER BY Bstate DESC";
    }
